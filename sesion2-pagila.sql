...
-- trae registros de tabla 'city' en columna llamada 'city' donde los registros comiencen con 'A'
...
-- trae registros de tabla 'film' en columna 'description' donde haya la palabra 'Drama' sin importar posición
